...
{prod-short} uses the {devworkspace} engine that targets v2 devfiles. (SchemaVersion is 2.1.0)
Using devfile v1 is still possible but deprecated. Under the hood, https://github.com/che-incubator/devfile-converter[converter library], converts devfiles v1 to devfiles v2.
